...
for (var t = arguments[0], e = 1;e < arguments.length;e++)t = t.replace(RegExp("\\{" + (e - 1) + "\\}", "gm"), arguments[e]);return t;
 }, t.extend(e.prototype, {init: function() {
var t = this;this.buildNotify(), this.settings.content.icon && this.setIcon(), "#" != this.settings.content.url && this.styleURL(), this.placement(), this.bind(), this.notify = {$ele: this.$ele, update: function(e, s) {
var i = {};"string" == typeof e ? i[e] = s:i = e;for (var e in i) switch(e) {
 case "allow_dismiss":this.$ele.find('[data-notify="dismiss"]').css('display',i[e]==true?'inline':'none');break;
 case "type":this.$ele.removeClass("alert-" + t.settings.type), this.$ele.find("[data-notify=\"progressbar\"] > .progress-bar").removeClass("progress-bar-" + t.settings.type), t.settings.type = i[e], this.$ele.addClass("alert-" + i[e]).find("[data-notify=\"progressbar\"] > .progress-bar").addClass("progress-bar-" + i[e]);break;case "icon":var n = this.$ele.find("[data-notify=\"icon\"]");"class" == t.settings.icon_type.toLowerCase() ? n.removeClass(t.settings.content.icon).addClass(i[e]):(n.is("img") || n.find("img"), n.attr("src", i[e]));break;case "progress":var a = t.settings.delay - t.settings.delay * (i[e] / 100);this.$ele.data("notify-delay", a), this.$ele.find("[data-notify=\"progressbar\"] > div").attr("aria-valuenow", i[e]).css("width", i[e] + "%");break;case "url":this.$ele.find("[data-notify=\"url\"]").attr("href", i[e]);break;case "target":this.$ele.find("[data-notify=\"url\"]").attr("target", i[e]);break;default:this.$ele.find("[data-notify=\"" + e + "\"]").html(i[e])
