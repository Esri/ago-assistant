...
;!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports):"function"==typeof define&&define.amd?define(["exports"],t):t(e.portal={})}(this,function(e){"use strict";function t(e,t,n){return n=void 0!==n?n:{withCredentials:!1},new Promise(function(i,o){var s=new XMLHttpRequest;s.withCredentials=n.withCredentials,s.addEventListener("readystatechange",function(){if(4===s.readyState&&200==s.status){var e=void 0;e=""===s.response?null:JSON.parse(s.response),i(e)}else 4===s.readyState&&500==s.status&&o(Error(s))}),s.addEventListener("error",function(){o(Error(s))}),s.open("GET",e+"?"+r(t)),s.timeout=12e4,s.ontimeout=function(){console.log("timeout"),o(Error(s))},s.send()})}function n(e,t,n){return n=void 0!==n?n:{withCredentials:!1},new Promise(function(i,o){var s=new XMLHttpRequest;s.withCredentials=n.withCredentials,s.addEventListener("readystatechange",function(){if(4===s.readyState&&200==s.status){var e=void 0;e=""===s.response?null:JSON.parse(s.response),i(e)}else 4===s.readyState&&500==s.status&&o(Error(s))}),s.addEventListener("error",function(){o(Error(s))}),s.open("POST",e),s.timeout=12e4,s.ontimeout=function(){console.log("timeout"),o(Error(s))},s.setRequestHeader("content-type","application/x-www-form-urlencoded"),s.send(r(t))})}function r(e,t){var n=[];for(var i in e)if(e.hasOwnProperty(i)){var o=t?t+"["+i+"]":i,s=e[i];n.push("object"==(void 0===s?"undefined":D(s))?r(s,o):encodeURIComponent(o)+"="+encodeURIComponent(s))}return n.join("&")}function i(e,t){var n=this,r=n.portalUrl+"sharing/rest/generateToken",i={client:"referer",referer:window.location.hostname,expiration:60,username:e,password:t,f:"json"},o={withCredentials:n.withCredentials};return T.post(r,i,o)}function o(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"",i=this,o=i.portalUrl+"sharing/rest/search",s={q:e,num:t,sortField:n,sortOrder:r,token:i.token,f:"json"},a={withCredentials:i.withCredentials};return T.get(o,s,a)}function s(){var e=this,t=e.portalUrl+"sharing/rest/portals/self",n={token:e.token,f:"json"},r={withCredentials:e.withCredentials};return T.get(t,n,r)}function a(){var e=this,t=e.portalUrl+"sharing/rest",n={f:"json"},r={withCredentials:e.withCredentials};return T.get(t,n,r)}function l(e,t){var n=this,r=n.portalUrl+"sharing/rest/content/users/"+e+"/"+t,i={token:n.token,f:"json"},o={withCredentials:n.withCredentials};return T.get(r,i,o)}function c(e){var t=this,n=t.portalUrl+"sharing/rest/community/users/"+e,r={token:t.token,f:"json"},i={withCredentials:t.withCredentials};return T.get(n,r,i)}function u(e,t,n,r,i){var o=this,s=o.portalUrl+"sharing/rest/content/users/"+e+"/"+t+"/addItem";for(var a in n)null===n[a]?n[a]="":n[a]instanceof Array&&(n[a]=n[a].toString());var l={item:n.title,overwrite:!1,thumbnailurl:i,token:o.token,f:"json"};"object"===(void 0===r?"undefined":D(r))&&null!==r?l.text=JSON.stringify(r):l.text="",Object.assign(l,n);var c={withCredentials:o.withCredentials};return T.post(s,l,c)}function h(e){var t=this,n=t.portalUrl+"sharing/rest/content/items/"+e+"/data",r={token:t.token,f:"json"},i={withCredentials:t.withCredentials};return T.get(n,r,i)}function d(e){var t=this,n=t.portalUrl+"sharing/rest/content/items/"+e,r={token:t.token,f:"json"},i={withCredentials:t.withCredentials};return T.get(n,r,i)}function p(e,t,n,r){var i=this,o=i.portalUrl+"sharing/rest/content/users/"+e+"/"+n+"/items/"+t+"/update",s={text:r,token:i.token,f:"json"},a={withCredentials:i.withCredentials};return T.post(o,s,a)}function f(e,t,n,r){var i=this,o=i.portalUrl+"sharing/rest/content/users/"+e+"/"+n+"/items/"+t+"/update",s=JSON.parse(r),a=!0,l=!1,c=void 0;try{for(var u,h=Object.keys(s)[Symbol.iterator]();!(a=(u=h.next()).done);a=!0){var d=u.value,p=s[d];null===p?s[d]="":p instanceof Array&&(s[d]=p.toString())}}catch(e){l=!0,c=e}finally{try{!a&&h.return&&h.return()}finally{if(l)throw c}}s.token=i.token,s.f="json";var f={withCredentials:i.withCredentials};return T.post(o,s,f)}function y(e,t,n,r){var i=this,o=i.portalUrl+"sharing/rest/content/users/"+e+"/"+t+"/items/"+n+"/update",s={url:r,token:i.token,f:"json"},a={withCredentials:i.withCredentials};return T.post(o,s,a)}function v(e,t,n,r){var i=this,o=i.portalUrl+"sharing/rest/content/users/"+e+"/"+t+"/items/"+n+"/update",s={text:JSON.stringify(r),token:i.token,f:"json"},a={withCredentials:i.withCredentials};return T.post(o,s,a)}function w(e,t,n){var r=this,i=e+"/"+t+"/addFeatures",o={features:n,token:r.token,f:"json"},s={withCredentials:r.withCredentials};return T.post(i,o,s)}function m(e,t){var n=this;e=e.replace("/rest/services/","/rest/admin/services/");var r=e+"/addToDefinition",i={addToDefinition:t,token:n.token,f:"json"},o={withCredentials:n.withCredentials};return T.post(r,i,o)}function C(e){this.items.push({id:e.id,description:e})}function g(e,t,n){var r=this,i=r.portalUrl+"sharing/rest/portals/"+e+"/isServiceNameAvailable",o={name:t,type:n,token:r.token,f:"json"},s={withCredentials:r.withCredentials};return T.get(i,o,s)}function k(e,t,n){var r=this,i=r.portalUrl+"sharing/rest/content/users/"+e+"/"+t+"/createService",o={createParameters:n,outputType:"featureService",token:r.token,f:"json"},s={withCredentials:r.withCredentials};return T.post(i,o,s)}function S(e,t,n,r){var i=this,o=e+"/"+t+"/query",s={where:"1=1",outFields:"*",returnGeometry:!0,resultOffset:n,resultRecordCount:r,token:i.token,f:"json"},a={withCredentials:i.withCredentials};return T.get(o,s,a)}function b(e,t){var n=this,r=e+"/"+t+"/query",i={where:"1=1",returnCountOnly:!0,token:n.token,f:"json"},o={withCredentials:n.withCredentials};return T.get(r,i,o)}function j(e){var t=this,n=e,r={token:t.token,f:"json"},i={withCredentials:t.withCredentials};return T.get(n,r,i)}function U(e){var t=this,n=e+"/layers",r={token:t.token,f:"json"},i={withCredentials:t.withCredentials};return T.get(n,r,i)}function O(e){var t=P.filter(function(t){return t.type===e})[0];return t=void 0!==t?t:{icon:"datafilesGray"}}function x(e){return new Promise(function(t){""===e?e="https://www.arcgis.com/":e.search("/home/")>0?e=e.substr(0,e.search("/home"))+"/":e.search("/sharing")>0?e=e.substr(0,e.search("/sharing"))+"/":"/"!==e.charAt(e.length-1)&&(e+="/"),0===e.indexOf("http://")&&0===window.location.href.indexOf("https://")&&(e=e.replace("http://","https://")),t(e)})}function E(e){return 0===e.indexOf("http://")&&0===window.location.href.indexOf("https://")&&(e=e.replace("http://","https://")),e}function L(e){return O(e)}var D="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},G=function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")},T={get:t,post:n},P=[{type:"CityEngine Web Scene",icon:"webScene"},{type:"Color Set",icon:"datafilesGray"},{type:"Document Link",icon:"datafilesGray"},{type:"Image Service",icon:"imagery"},{type:"Feature Collection",icon:"features"},{type:"Feature Collection Template",icon:"maps"},{type:"Feature Layer",icon:"features"},{type:"Feature Service",icon:"features"},{type:"Geocoding Service",icon:"layers"},{type:"Geodata Service",icon:"layers"},{type:"Geometry Service",icon:"layers"},{type:"Geoprocessing Service",icon:"layers"},{type:"Globe Service",icon:"layers"},{type:"Network Analysis Service",icon:"layers"},{type:"Map Service",icon:"layers"},{type:"Mobile Application",icon:"apps"},{type:"Operation View",icon:"apps"},{type:"Scene Layer",icon:"sceneLayer"},{type:"Scene Service",icon:"sceneLayer"},{type:"Service Definition",icon:"datafiles"},{type:"Symbol Set",icon:"datafiles"},{type:"Web Map",icon:"maps"},{type:"Web Mapping Application",icon:"apps"},{type:"Web Scene",icon:"webScene"},{type:"WMS",icon:"layers"}],F=Object.freeze({fixUrl:x,upgradeUrl:E}),M=function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=t.portalUrl,r=void 0===n?"https://www.arcgis.com":n,O=t.username,x=void 0===O?"":O,E=t.token,L=void 0===E?"":E,D=t.withCredentials,T=void 0!==D&&D;G(this,e),this.portalUrl=r,this.username=x,this.token=L,this.withCredentials=T,this.items=[],this.services=[],this.generateToken=i,this.search=o,this.self=s,this.version=a,this.userContent=l,this.userProfile=c,this.itemDescription=d,this.itemData=h,this.addItem=u,this.updateWebmapData=v,this.updateDescription=f,this.updateData=p,this.updateUrl=y,this.serviceDescription=j,this.serviceLayers=U,this.layerRecordCount=b,this.createService=k,this.addToServiceDefinition=m,this.checkServiceName=g,this.harvestRecords=S,this.addFeatures=w,this.cacheItem=C},N=F;e.Portal=M,e.itemInfo=L,e.util=N,Object.defineProperty(e,"__esModule",{value:!0})});
